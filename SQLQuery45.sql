-- Tao mot stored procedure de lay thông tin 
-- ve san pham dua trên tên san pham duoc cung cap.
...
-- Tao mot stored procedure de tính tung doanh so bán hàng
...
-- Tao mot stored procedure de cap nhat giá cua tat
